...
import { Check, Mic, Lightbulb, Clock, Shield, TrendingUp, BarChart3, Star } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-warm-brown-50">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                  ...
                  <span className="text-coral-500 block">Build confidence.</span>
                </h1>
                <p className="text-xl text-warm-brown-600 leading-relaxed max-w-2xl">
                  Safe, AI-powered conversation practice designed for socially self-aware individuals who want to improve their interpersonal connections through guided voice conversations.
                </p>
              </div>
                ...
                <CardContent className="p-8 h-full">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-end">
                      <div className="bg-coral-100 rounded-2xl p-4 max-w-xs">
                        <p className="text-warm-brown-700 text-sm">"How was your weekend?"</p>
                      </div>
                    </div>
                    <div className="flex justify-start">
                      <div className="bg-sage-100 rounded-2xl p-4 max-w-xs">
                        <p className="text-warm-brown-700 text-sm">"It was great! I went hiking with friends and discovered a beautiful trail..."</p>
                      </div>
                    </div>
                    <div className="flex justify-end">
                      <div className="bg-coral-100 rounded-2xl p-4 max-w-xs">
                        <p className="text-warm-brown-700 text-sm">"That sounds wonderful! What made it special?"</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-warm-brown-700 rounded-xl p-4 text-white">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm">AI analyzing conversation...</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section id="how-it-works" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6 mb-16">
            <h2 className="text-4xl font-bold text-warm-brown-800">How It Works</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center space-y-6 p-6">
              ...
              <h3 className="text-2xl font-semibold text-warm-brown-800">Start Talking</h3>
              <p className="text-warm-brown-600">
                Begin a 5-minute voice conversation with our AI coach about "How was your weekend?" in a safe, judgment-free environment.
              </p>
            </div>
            ...
            <div className="text-center space-y-6 p-6">
              ...
              <h3 className="text-2xl font-semibold text-warm-brown-800">AI Analysis</h3>
              <p className="text-warm-brown-600">
                Our advanced AI analyzes your conversation, identifying strengths, areas for improvement, and communication patterns.
              </p>
            </div>
            ...
            <div className="text-center space-y-6 p-6">
              ...
              <h3 className="text-2xl font-semibold text-warm-brown-800">Get Feedback</h3>
              <p className="text-warm-brown-600">
                Receive personalized, actionable feedback with annotations and suggestions to improve your conversation skills.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="py-20 sage-gradient">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6 mb-16">
            <h2 className="text-4xl font-bold text-warm-brown-800">Why Choose Conversly?</h2>
            <p className="text-xl text-warm-brown-600 max-w-3xl mx-auto">
              Designed specifically for socially self-aware individuals seeking genuine improvement
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-warm-brown-800 mb-4">Safe Environment</h3>
                <p className="text-warm-brown-600">
                  Practice without judgment in a supportive space designed for growth and learning.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-warm-brown-800 mb-4">Voice-First Practice</h3>
                <p className="text-warm-brown-600">
                  Authentic conversation practice using natural speech patterns and vocal communication.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-warm-brown-800 mb-4">Quick Sessions</h3>
                <p className="text-warm-brown-600">
                  Perfect 5-minute sessions that fit into your busy schedule without overwhelming commitment.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-warm-brown-800 mb-4">AI-Powered Insights</h3>
                <p className="text-warm-brown-600">
                  Advanced analysis of your communication patterns with actionable improvement suggestions.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold text-warm-brown-800 mb-4">Continuous Improvement</h3>
                <p className="text-warm-brown-600">
                  Build confidence progressively with each session, tracking your growth journey.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 coral-gradient">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6 mb-16">
            ...
            <p className="text-xl text-warm-brown-600 max-w-3xl mx-auto">
              Real feedback from people improving their conversation skills
            </p>
          </div>
              ...
              <CardContent className="p-8">
                <div className="space-y-4">
                  ...
                  <p className="text-warm-brown-700 leading-relaxed">
                    "The feedback is incredibly detailed and helpful. I've noticed real improvement in my confidence during work meetings after just a few weeks."
                  </p>
                  <div className="pt-4 border-t border-warm-brown-100">
                    <p className="font-medium text-warm-brown-800">Sarah M.</p>
                    <p className="text-sm text-warm-brown-600">Software Engineer</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white shadow-lg">
              <CardContent className="p-8">
                <div className="space-y-4">
                  ...
                  <p className="text-warm-brown-700 leading-relaxed">
                    "As an introvert, this has been a game-changer. The safe environment lets me practice without the anxiety of real social pressure."
                  </p>
                  <div className="pt-4 border-t border-warm-brown-100">
                    <p className="font-medium text-warm-brown-800">David L.</p>
                    <p className="text-sm text-warm-brown-600">Marketing Analyst</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white shadow-lg">
              <CardContent className="p-8">
                <div className="space-y-4">
                  ...
                  <p className="text-warm-brown-700 leading-relaxed">
                    "The 5-minute sessions are perfect. I can practice during my lunch break and the AI feedback helps me understand exactly what to improve."
                  </p>
                  <div className="pt-4 border-t border-warm-brown-100">
                    <p className="font-medium text-warm-brown-800">Rachel K.</p>
                    <p className="text-sm text-warm-brown-600">Product Manager</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-8">
            ...
            <p className="text-xl text-warm-brown-200 max-w-3xl mx-auto">
              Join hundreds of socially self-aware individuals who are improving their interpersonal connections through guided voice conversations.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-warm-brown-300">
                Safe, AI-powered conversation practice for building interpersonal confidence.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-warm-brown-300 hover:text-white transition-colors">
